...
import {ChannelState, Balance} from './clients/payment-channel-client';
...
const peer = (signingAddress, balance: number): Balance => ({
  signingAddress,
...
export const mockChannels: Array<Partial<ChannelState>> = [
  {
    ...
    receiver: peer(mockCurrentUser, mockBalance)
  },
  {
  ...
  },
  {
    ...
    receiver: peer(mockSeeder, mockBalance * 2)
  }
];
